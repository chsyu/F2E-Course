        ...
        <div class="group transition-all duration-300 cursor-pointer bg-white rounded-lg shadow-md overflow-hidden h-full flex flex-col">
          ...
          <div class="p-6 flex flex-col flex-grow">
            ...
            <div class="mt-auto">
              ...
              <a href="#" class="block text-center w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg transition duration-300 transform hover:-translate-y-1 shadow-md">
